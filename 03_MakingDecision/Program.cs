...
namespace _03_MakingDecision
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //if (number == 5 )
            //{
            //    Console.WriteLine("Sayılar Doğru");
            //}
            //else
            //{
            //    Console.WriteLine("Sayılar Hatalı");
            //}
            ...
            //Console.Write("Sınavların Ortalamsı: " + average);
            ...
            //if(username != "admin")
            //  {
            //      Console.Write("BU KULLANICI ADI KABUL EDİLEMEZ");
            //  }
            //  else
            //  {
            ...
            //Console.Write(" Lütfenn 2. sayıyı giriniz:");
            ...
            //    Console.Write("Hangi içeceği almak istersiniz: ");

            //    string icecek = Console.ReadLine();

            //    if (icecek == "1")
            //    {
            //        Console.WriteLine("Kola: 15 lira");
            //    }
            //    if (icecek == "2")
            //    {
            //        Console.WriteLine("Ayran: 12 lira");
            //    }

            //    if (icecek == "3")
            //    {
            //        Console.WriteLine("Su: 5 lira");
            //    }
            //}
